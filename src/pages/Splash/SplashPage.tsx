  ...
  return (
    <div className={cn('min-h-screen w-full bg-white flex justify-center items-center')}>
      <div className={cn('w-full max-w-[360px] min-h-screen bg-white relative flex flex-col overflow-hidden')}>
        {/* 배경 이미지 */}
        <div
          className={cn('absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[360px] h-[800px]')}
        >
        ...
        <div
          className={cn(
            'absolute left-[116.87px] top-[343.7px] w-[118.26px] h-[65.615px] flex items-center justify-center'
          )}
        >
